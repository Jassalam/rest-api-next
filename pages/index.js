...
const endpoints=[
  ...
  {
    name: 'GET /trips/:id',
    description: 'Get the details of trips',
    parameters: [
      {
        name: 'id',
  ...
  },
  {
    ...
    parameters: [
      {name: 'user', description: '*required* the id of user'},
      {name: 'name', description: '*required* the name of trip'},
      {name: 'start_date', description: '(optional) the starting date of trip'},
      {name: 'end_date', description: '(optional) the end date of trip'},
    ],
  },
  {
    name: 'PUT /trips/:id',
    description: 'Edit a trips',
    parameters: [
      {
        name: 'id',
        description: '*required* the number that identifies the trip',
      ...
      {
        name: 'name', 
        description: '(optional) the name of trip',
      },
      {
      name: 'start_date', 
      description: '(optional) the starting date of trip',
    },
      {
        name: 'end_date', 
        description: '(optional) the end date of trip',
      },
    ],
  },
  {
